...
개인 독서 기록(진도·타임라인·인용구·통계·스트릭)을 위한 1단계 앱. 읽고, 남기고, 나누는 경험을 기록하며 이후 소셜 공유(2단계), 소그룹 커뮤니티(3단계)로 확장 예정.
...
- 독서 노트, 지속 타이머, 전체 타임라인, 기록 수정·휴지통·복원, 출처를 넣은 인용구·메모 복사/메일/문자 공유, 실제 DB 책장 요약, 기간별 통계를 지원함.
